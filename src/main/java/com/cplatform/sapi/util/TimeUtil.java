...
public class TimeUtil {
	...
	public static String addMinutesTim(String strTime, int amount) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		try {
			Date d = sdf.parse(strTime);
			return TimeUtil.format(DateUtils.addMinutes(d, amount), TARGET_1);
		}
		catch (ParseException e) {
			return "";
		}
	...
	public static String addDaysTim(String strTime, int days) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		try {
			Date d = sdf.parse(strTime);
			return TimeUtil.format(DateUtils.addMinutes(d, days), TARGET_1);
		}
		catch (ParseException e) {
			return "";
		}
	...
	public static String addDaysTIM(Date d, int days) {
		return TimeUtil.format(DateUtils.addDays(d, days), TARGET_1);
	}
